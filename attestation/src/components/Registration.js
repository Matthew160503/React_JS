        ...
        <>
            <section className="top_title">
                <div className="top_title_b center">
                    <h1 className="top_title_b_title">REGISTRATION</h1>
                </div>
            </section>
            ...
            <main>
                <div className="registration center">
                    <div className="fields">
                        <div className="f_box">
                            <h3 className="fields__names">Your Name</h3>
                            <input
                        ...
                        <div className="f_box">
                            <h3 className="fields__names">Login details</h3>
                            <input
                                className="entry-field "
                                required
                                min="1"
                        ...
                        <p className="fields__description">
                    ...
                    <div className="loyalty">
                        <h2 className="loyalty__name">LOYALTY HAS ITS PERKS</h2>
                        ...
                        <ul className="loyalty__list">
                            <li className="loyalty__list__paragraph">
