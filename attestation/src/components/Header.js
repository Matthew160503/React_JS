...
function Header(props) {
    ...
    return (
        <header className="header">
            <section className="header_block center">
                <div className="header_block_left_side">
                    <Link to="/">
                ...
                <nav className="header_block_right_side">
                    ...
                    <Link to="/registration" className="out hov">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="29"
                            height="29"
                    ...
                    <Link to="/cart" className="out hov plus">
                        <p className="count-add-items"></p>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="32"
                            height="29"
                ...
                <input className="burger" id="burger" type="checkbox" />
                <div className="nav">
                    <h5 className="nav_menu">MENU</h5>
                    <div className="nav_cat">
                        {gender.map((el) => (
                            <div
                                onClick={() => props.chooseCategory(el.key)}
                                key={el.key}
                                className="nav_cat_block"
                            >
                                <Link to={`/catalog/${el.key}`}>
                                    <h6 className="nav_cat_block_name">
                                        {el.name}
                                    </h6>
                                </Link>
                            </div>
